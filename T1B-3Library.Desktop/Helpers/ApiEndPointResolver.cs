...
{
    /// <summary>
    /// Responsável por descobrir automaticamente a URL base da API T1B-3Library.
    /// Elimina a necessidade de portas hardcoded no código.
    /// </summary>
    /// <remarks>
    /// Ordem de resolução:
    ///   1. launchSettings.json do projeto T1B-3Library.API (desenvolvimento)
    ...
    public static class ApiEndpointResolver
    {
        ...
        /// </summary>
        private const string ApiProjectName = "T1B-3Library.API";
        ...
        public static string? Resolve()
        {
            ...
            Log("   Verifique se T1B-3Library.API/Properties/launchSettings.json existe");
        ...
        /// <summary>
        /// Tenta localizar e parsear o launchSettings.json do projeto T1B-3Library.API.
